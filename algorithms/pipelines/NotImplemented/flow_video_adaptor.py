...
class FlowMatchingVideoFineTuner(FlowMatchingAdaptor, FlowMatchingVideo):
    ...
    def validation_step(self, batch, batch_idx, namespace="validation") -> STEP_OUTPUT:
        ...
        num_flow = self.cfg.get('num_flow_trials')
        if num_flow is not None and num_flow > 1:
            xs = xs.repeat(1, num_flow, 1, 1, 1)
        ...
        for step in range(0, num_sliding_windows):
            ...
            if step % open_loop_horizon == 0:
                ...
                if step == 0 or self.save_inference:
                    ...
                    xs_best_pred[prediction_window], xs_pred_hist = self.flow_matching_sampling(xs_context=xs[:t_real],
